...
export class YouTube extends React.Component<Props> {
    ...
    static propertyControls: PropertyControls<Props> = {
        ...
        play: {
            ...
            title: "Autoplay",
            options: [YouTube.playNormal, YouTube.playAuto, YouTube.playLoop],
        },
    ...
    render() {
        ...
        const identifier =
            YouTube.guessIdentifier(url || YouTube.defaultProps.url) || "none" // At time of writing, an incorrect video ID produces an embed with a black background and play icon
        const autoplay =
            RenderTarget.current() == RenderTarget.preview &&
            (play === YouTube.playAuto || play === YouTube.playLoop)
        ...
        return (
            <iframe width={"100%"} height={"100%"} frameBorder={0} src={src} />
        )
    }
